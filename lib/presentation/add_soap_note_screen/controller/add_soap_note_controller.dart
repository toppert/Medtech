...
TextEditingController frame229twoController = TextEditingController();

Rx<AddSoapNoteModel> addSoapNoteModelObj = AddSoapNoteModel().obs;

@override void onClose() { super.onClose(); fullNameController.dispose(); dateofbirthvaluController.dispose(); dateController.dispose(); assessmentvalueController.dispose(); assessmentvalueController1.dispose(); enterController.dispose(); enteroneController.dispose(); entertwoController.dispose(); frame229Controller.dispose(); frame229oneController.dispose(); frame229twoController.dispose(); } 
 }
