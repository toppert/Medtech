import '../consultations1_screen/widgets/userprofile1_item_widget.dart';
...
class Consultations1Screen extends GetWidget<Consultations1Controller> {
  const Consultations1Screen({Key? key})
      : super(
          key: key,
        );
                          ...
                          child: Padding(
                            ...
                            child: Obx(
                              () => ListView.separated(
                                ...
                                itemCount: controller.consultations1ModelObj
                                    .value.userprofile1ItemList.value.length,
                                itemBuilder: (context, index) {
                                  Userprofile1ItemModel model = controller
                                      .consultations1ModelObj
                                      .value
