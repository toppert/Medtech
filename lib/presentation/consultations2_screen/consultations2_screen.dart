import '../consultations2_screen/widgets/userprofile2_item_widget.dart';
...
class Consultations2Screen extends GetWidget<Consultations2Controller> {
  const Consultations2Screen({Key? key})
      : super(
          key: key,
        );
