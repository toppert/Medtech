...
class CreateStoryController extends GetxController {TextEditingController enterController = TextEditingController();
...
@override void onClose() { super.onClose(); enterController.dispose(); checkmarkController.dispose(); } 
 }
