...
class ReviewBookingController extends GetxController {TextEditingController checkmarkController = TextEditingController();

Rx<ReviewBookingModel> reviewBookingModelObj = ReviewBookingModel().obs;

@override void onClose() { super.onClose(); checkmarkController.dispose(); } 
 }
