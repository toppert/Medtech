import 'controller/side_navigation1_controller.dart';
import 'package:flutter/material.dart';
import 'package:medtech/core/app_export.dart';
import 'package:medtech/widgets/custom_text_form_field.dart';

class SideNavigation1Draweritem extends StatelessWidget {
  SideNavigation1Draweritem(
    this.controller, {
    Key? key,
  }) : super(
          key: key,
  ...
  SideNavigation1Controller controller;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            CustomTextFormField(
              controller: controller.billingsvalueController,
              margin: EdgeInsets.only(
                top: 15.v,
                right: 5.h,
              ),
              hintText: "lbl_billings".tr,
