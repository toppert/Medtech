import 'controller/side_navigation4_controller.dart';
import 'package:flutter/material.dart';
import 'package:medtech/core/app_export.dart';
import 'package:medtech/widgets/custom_text_form_field.dart';

class SideNavigation4Draweritem extends StatelessWidget {
  SideNavigation4Draweritem(
    this.controller, {
    Key? key,
  }) : super(
          key: key,
  ...
  SideNavigation4Controller controller;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            CustomTextFormField(
              controller: controller.labtestsoneController,
              margin: EdgeInsets.only(
                top: 15.v,
                right: 5.h,
              ),
              hintText: "lbl_lab_tests".tr,
              hintStyle: CustomTextStyles.titleSmallPrimary,
              textInputAction: TextInputAction.done,
              prefix: Container(
                margin: EdgeInsets.fromLTRB(10.h, 15.v, 13.h, 15.v),
                child: CustomImageView(
                  svgPath: ImageConstant.imgLabsvgrepocom1,
                ),
              ),
