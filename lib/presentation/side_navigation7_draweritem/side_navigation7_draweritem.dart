import 'controller/side_navigation7_controller.dart';
import 'package:flutter/material.dart';
import 'package:medtech/core/app_export.dart';
import 'package:medtech/widgets/custom_text_form_field.dart';

class SideNavigation7Draweritem extends StatelessWidget {
  SideNavigation7Draweritem(
    this.controller, {
    Key? key,
  }) : super(
          key: key,
  ...
  SideNavigation7Controller controller;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            CustomTextFormField(
              controller: controller.pharmacyvalueController,
              margin: EdgeInsets.only(
                top: 29.v,
                right: 5.h,
              ),
              hintText: "lbl_pharmacy".tr,
              hintStyle: CustomTextStyles.titleSmallPrimary,
              textInputAction: TextInputAction.done,
              prefix: Container(
                margin: EdgeInsets.fromLTRB(10.h, 15.v, 13.h, 15.v),
                child: CustomImageView(
                  svgPath: ImageConstant.imgPharmacysvgrepocom11,
                ),
              ),
