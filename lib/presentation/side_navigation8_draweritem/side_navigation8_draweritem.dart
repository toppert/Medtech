import 'controller/side_navigation8_controller.dart';
import 'package:flutter/material.dart';
import 'package:medtech/core/app_export.dart';
import 'package:medtech/widgets/custom_text_form_field.dart';

class SideNavigation8Draweritem extends StatelessWidget {
  SideNavigation8Draweritem(
    this.controller, {
    Key? key,
  }) : super(
          key: key,
  ...
  SideNavigation8Controller controller;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            CustomTextFormField(
              controller: controller.medicationsvaluController,
              margin: EdgeInsets.only(
                top: 15.v,
                right: 5.h,
              ),
              hintText: "lbl_medications".tr,
              hintStyle: CustomTextStyles.titleSmallPrimary,
              textInputAction: TextInputAction.done,
              prefix: Container(
                margin: EdgeInsets.fromLTRB(10.h, 15.v, 13.h, 15.v),
                child: CustomImageView(
                  svgPath: ImageConstant.imgPillssvgrepocom1,
                ),
              ),
