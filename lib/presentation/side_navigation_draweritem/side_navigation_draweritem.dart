import 'controller/side_navigation_controller.dart';
...
class SideNavigationDraweritem extends StatelessWidget {
  ...
  SideNavigationController controller;
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  CustomImageView(
                    svgPath: ImageConstant.imgCalendarsvgrepocomGray900,
                    height: 24.adaptSize,
                    width: 24.adaptSize,
                  ),
                  Padding(
            ...
            CustomTextFormField(
              controller: controller.patientsvalueController,
              margin: EdgeInsets.only(
                top: 15.v,
                right: 5.h,
              ),
              hintText: "lbl_patients".tr,
              hintStyle: CustomTextStyles.titleSmallPrimary,
              textInputAction: TextInputAction.done,
              prefix: Container(
                margin: EdgeInsets.fromLTRB(10.h, 15.v, 13.h, 15.v),
                child: CustomImageView(
                  svgPath: ImageConstant.imgGrouppeoplesvgrepocom2,
                ),
              ),
